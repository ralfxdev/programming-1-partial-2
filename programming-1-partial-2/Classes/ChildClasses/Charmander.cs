...
namespace programming_1_partial_2.Classes.ChildClasses
{
    ...
    {
        public Charmander(string name, int level, int health, int attack, int defense, int speed, int experience, int requiredExperience) : base(name, level, health, attack, defense, speed, experience, requiredExperience)
        {
        }

        private void Ember(Pokemon enemy)
        {
        ...
        private void FireSpin(Pokemon enemy)
        {
