...
namespace programming_1_partial_2.Classes.ChildClasses
{
    ...
    {
        public Pikachu(string name, int level, int health, int attack, int defense, int speed, int experience, int requiredExperience) : base(name, level, health, attack, defense, speed, experience, requiredExperience)
        {
        }
        ...
        private void QuickAttack(Pokemon enemy)
        {
        ...
        private void IronTail(Pokemon enemy)
        {
